function [x_results nsteps]= solve_gauss_seidel(a, b, tol)
...
% [ans_r steps] = solve_gauss_seidel([7 3 -1 2;3 8 1 -4;-1 1 4 -1; 2 -4 -1 6],[-1 0 -3 1].', 0.001)
